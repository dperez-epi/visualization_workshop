...
addStyle(wb, 'State urates', style=pct, cols=c(2), rows=2:(nrow(state_unemp)), gridExpand=TRUE)
addStyle(wb, 'County urates', style=pct, cols=c(3), rows=2:(nrow(state_county_unemp)), gridExpand=TRUE)
addStyle(wb, 'County urates, by race', style=pct, cols=c(3:7), rows=2:(nrow(state_county_unemp_wbhao)), gridExpand=TRUE)
#Accounting format
addStyle(wb, 'State urates', style=acct, cols=c(3:4), rows=2:(nrow(state_unemp)), gridExpand=TRUE)
addStyle(wb, 'County urates', style=acct, cols=c(4:5), rows=2:(nrow(state_county_unemp)), gridExpand=TRUE)
